...
I'm a Senior Data Engineer living in NYC with about eight years of experience in big data. 

I currently work at Capital One but previously worked at Amazon, Spotify, and BuzzFeed, as well as a couple of start-ups. I also maintain [`boto3-refresh-session`](https://github.com/michaelthomasletts/boto3-refresh-session) which is used by various teams across universities, small companies, and FAANG, with total downloads at 181K :tada: I am also the founder of [61418](https://github.com/61418), which is an independent open-source foundation that brings together engineers enhancing the general AWS ecosystem.
...
Currently, I am building a CLI tool which I plan to release in late Q2 2026. 
