...
- [boto3-refresh-session](https://github.com/61418/boto3-refresh-session) influenced the creation of the `aws configure mfa-login` command and introduction of the `aws_session_token` parameter for the `aws configure` command in [AWS CLI (v2.30.3)]([https://github.com/aws/aws-cli/blob/5bffffcc1bd0aa0e73bdcc1cfe432b37563a58bb/CHANGELOG.rst#L2081](https://github.com/aws/aws-cli/blob/5bffffcc1bd0aa0e73bdcc1cfe432b37563a58bb/CHANGELOG.rst?plain=1#L2081))
