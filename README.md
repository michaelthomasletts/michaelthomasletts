...
[`boto3-refresh-session`](https://github.com/michaelthomasletts/boto3-refresh-session) which is used by various teams across universities, small companies, and FAANG, with total downloads at 129.5K :tada:
...
Personally, I enjoy reading theory and philosophy, lifting weights, cooking, contributing to the open-source community, working on my 1997 Toyota Tacoma, and spending quality time with friends. I also have Retinitis Pigmentosa, which is a form of Inherited Retinal Degeneration, and consider myself an advocate for the blind. 
